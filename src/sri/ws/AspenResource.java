...
public class AspenResource {
	...
	@GET 
	@Path("usdot/{usDotNumber}")
    @Consumes({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
    @Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
	public Inspection getInspectionByUsDotNumber(@PathParam("usDotNumber") String usDotNumber) {
		Inspection inspection = aspenDao.getInspectionForUsDotNumber(usDotNumber);
		return inspection;
	}
